    ...
    const handleLogin = (e)=>{
        ...
        if(!users){
            Swal.fire({
              ...
              }).then(function(){navigate('/register')})
        }
        else{
            let index,found_email=false,correct_password=false;
            for(let i in users){
            ...
            else if(index!==undefined&&found_email&&correct_password===false){
                Swal.fire({
                    icon: "error",
        ...
        <div id="login_form_container">
            ...
            <form onSubmit={handleLogin} id="loginForm">
                ...
                <div>
                    ...
                    <br/>
                    <input type='password' id="password" onChange={handleData} minLength='5' required/>
                </div>
                <div>
                    <button type='submit' id="submit_login_form">Login</button>
                </div>
            </form>
